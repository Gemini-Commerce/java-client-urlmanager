...
public class RpcStatus {
   ...
   * @return the RpcStatus instance itself
   */
  public RpcStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, rpcStatus.code) &&
        ...
        Objects.equals(this.additionalProperties, rpcStatus.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RpcStatus>() {
           ...
           public RpcStatus read(JsonReader in) throws IOException {
             ...
             RpcStatus instance = thisAdapter.fromJsonTree(jsonObj);
