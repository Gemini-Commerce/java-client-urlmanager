...
public class UrlmanagerCreateUrlRewriteRequest {
   ...
   * @return the UrlmanagerCreateUrlRewriteRequest instance itself
   */
  public UrlmanagerCreateUrlRewriteRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, urlmanagerCreateUrlRewriteRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, urlmanagerCreateUrlRewriteRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, context, requestPath, targetPath, redirectType, linkRel, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UrlmanagerCreateUrlRewriteRequest>() {
           ...
           public UrlmanagerCreateUrlRewriteRequest read(JsonReader in) throws IOException {
             ...
             UrlmanagerCreateUrlRewriteRequest instance = thisAdapter.fromJsonTree(jsonObj);
