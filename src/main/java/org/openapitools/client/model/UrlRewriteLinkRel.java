...
/**
 * Gets or Sets UrlRewriteLinkRel
 */
@JsonAdapter(UrlRewriteLinkRel.Adapter.class)
public enum UrlRewriteLinkRel {
  ...
  UrlRewriteLinkRel(String value) {
    this.value = value;
  }
  ...
  public static UrlRewriteLinkRel fromValue(String value) {
    for (UrlRewriteLinkRel b : UrlRewriteLinkRel.values()) {
  ...
  public static class Adapter extends TypeAdapter<UrlRewriteLinkRel> {
    @Override
    public void write(final JsonWriter jsonWriter, final UrlRewriteLinkRel enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UrlRewriteLinkRel read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UrlRewriteLinkRel.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UrlRewriteLinkRel.fromValue(value);
  }
}
